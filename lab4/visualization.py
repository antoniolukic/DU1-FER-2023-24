...
if __name__ == '__main__':
    ...
    # LOAD TRAINED PARAMS
    model_path = 'saved_model/reduced_model_2.pth'
    ...
    plot_with_labels(test_img_rep2d, Y, colormap, "PCA from Images", path='./outputs/original_reduced_classes.png')
    ...
    with torch.no_grad():
        ...
        plot_with_labels(test_rep2d, Y, colormap, "PCA from Feature Representation", path='./outputs/feature_reduced_classes.png')
